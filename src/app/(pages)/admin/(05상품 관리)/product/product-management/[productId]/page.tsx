...
const Page = () => {
  ...
  return (
    <section>
      ...
      <div className="py-8 px-10 mt-10 rounded-[20px] bg-white">
        <div className="flex items-center gap-8">
          <p className="font-bold text-base min-w-[82px] text-grayLight">
            썸네일
          </p>
          <div className="flex items-center gap-8">
            <button className="py-3 px-6 flex flex-col items-center justify-between gap-2 rounded-[10px] border-1 border-lightBorder">
              <Image
        ...
        <div className="flex items-center gap-8 mt-8">
          ...
          <div className="flex items-center gap-8">
            <div className="py-3 px-6 flex flex-col items-center justify-between  gap-2 rounded-[10px] border-1 border-lightBorder">
              <Image
                src={assets.importImage}
                alt="An example image"
                width={20}
        ...
        <div className="w-full flex items-center gap-8 mt-8">
          <div className="w-full flex items-center gap-8 ">
            <div className="w-[40%]">
              <InputWithLabel
                label="상품명"
                labelStyles="font-bold text-base min-w-[82px]  text-grayLight"
                placeholder="상품명 텍스트"
              />
            </div>
            ...
            <Button className="w-[10%] bg-mainBlack text-white rounded-md">
              변경
            </Button>
          </div>
        </div>
        ...
        <div className="w-full flex items-center gap-8 mt-8">
          <div className="w-full flex items-center gap-8 ">
            <div className="w-1/5">
              <DropDownWithLabel
                title="업종"
                titleStyles="font-bold text-base min-w-[82px]  text-grayLight"
            ...
            <div className="w-1/5">
              <DropDownWithLabel
                ...
                titleStyles="font-bold text-base text-grayLight min-w-[50px]"
                selectStyles="w-full"
              />
            </div>
            <div className="w-1/5">
              <DropDownWithLabel
                ...
                options={dropDownOptions1}
                defaultSelectedKeys={defaultDropDown1}
                titleStyles="font-bold text-base text-grayLight min-w-[80px]"
                selectStyles="w-full"
              />
            </div>
        ...
        <div className="w-full flex items-center gap-3 mt-8">
          ...
          <div className=" w-1/5">
            <InputWithLabel
              label="판매 개수"
              labelStyles="font-bold text-base !text-grayLight min-w-[80px]"
              inputStyles="w-full"
            />
          </div>
          <div className=" w-1/5">
